...
const int PTBlockSizeX = 48;
const int PTBlockSizeY = 32;
...
{
	mShader = Shader::create("path_integ_naive.glsl", { PTBlockSizeX, PTBlockSizeY, 1 },
...
void TriplePathIntegrator::renderOnePass()
{
	...
	int numX = (width + PTBlockSizeX - 1) / PTBlockSizeX;
	int numY = (height + PTBlockSizeY - 1) / PTBlockSizeY;
